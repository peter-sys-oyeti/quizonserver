                ...
                <section class="content">
                        <div class="body">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <?php if ($user) { ?>
                                <h1 style="margin-bottom: 40px;">Participant: <img src="<?php echo base_url('inc/img/user/'.$user->picture)?>" width="80px"> <?php echo $user->surname.' '.$user->firstname ?> <small>(Score: <?php echo $user->score ?>)</small> <small><a href="<?php echo base_url('admin/quiz_user') ?>">Change</a></small></h1>
                                <hr />
                            <?php } ?>
                                <!-- Question and answer -->
                            <?php if(isset($question_list) && isset($question_list[$question_no])): 
                                ...
                                <div>
                                    <p>
                                        <h2 style="margin-bottom: 40px;"> <?php echo (isset($question_no)?$question_no:'0')?> of <?php echo (isset($question_list)?count($question_list):'0')?> Bible Quiz Questions</h2>
                                    </p>
                                </div>
                                <!-- to show error -->
                                ...
                                <div style="margin-top: 30px;">
                                    <a href="<?php echo base_url('admin/quiz/'.($question_no+1)) ?>" class="btn btn-primary btn-lg pull-right">Next <i class='fa fa-arrow-right'></i></a>
                                </div>
                            <?php else: ?>

                                    <!-- Question and answer -->
                                <?php if(isset($question_list) && $question_list):
                                    echo "<h3>SUMMARY: Answered ".(isset($user->score)?$user->score:'0')." correctly out of ".(isset($question_list)?count($question_list):'0')." Questions</h3>";
                                    echo "<h3>Percentage Performance: ".(isset($user->percentage_score)?$user->percentage_score:'0')."%</h3>";
                                    $counter = 0;
                                ...
                                <?php endforeach;//end of summary question loop ?>
                                    <div style="margin-bottom: 100px;"><a href="<?php echo base_url('admin/quiz_user') ?>" class="btn btn-primary btn-lg pull-right">Next Participant ></a></div>
                                <?php else: ?>
